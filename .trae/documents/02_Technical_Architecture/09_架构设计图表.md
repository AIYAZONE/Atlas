...
graph LR
  ...
  subgraph "Frontend Monorepo (Vercel)"
  ...
  Builder -->|Direct SQL| DB
  Admin -->|Direct SQL| DB
  
  Builder -->|Sensitive| Functions
  Functions --> Shopify
  Functions --> ERP
  Functions --> CRM

  Functions -->|Preview| DB
  Functions -->|Publish| S3
